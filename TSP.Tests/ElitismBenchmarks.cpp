...
namespace Benchmarks {
	...
	TEST_METHOD(BenchMarkElitism0Medium) {
		...
		RunConfig(solver, graph, max_reps, "elitism\\elitism0_medium");
	}
	TEST_METHOD(BenchMarkElitism10Medium) {
		auto graph = ParseGraphFile<SymmetricAdjacencyMatrix<int>, int>(tsplib_symmetric_path + "eil51.txt");
		auto params = GeneticParameters(
			25,								// Population size
			50,								// Max Generations
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism10_medium");
	}
	TEST_METHOD(BenchMarkElitism20Medium) {
		auto graph = ParseGraphFile<SymmetricAdjacencyMatrix<int>, int>(tsplib_symmetric_path + "eil51.txt");
		auto params = GeneticParameters(
			25,								// Population size
			50,								// Max Generations
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism20_medium");
	}
	TEST_METHOD(BenchMarkElitism30Medium) {
		auto graph = ParseGraphFile<SymmetricAdjacencyMatrix<int>, int>(tsplib_symmetric_path + "eil51.txt");
		auto params = GeneticParameters(
			25,								// Population size
			50,								// Max Generations
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism30_medium");
	}

	TEST_METHOD(BenchMarkElitism0Big) {
		...
		auto params = GeneticParameters(
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism0_big");
	}
	TEST_METHOD(BenchMarkElitism10Big) {
		auto graph = ParseGraphFile<SymmetricAdjacencyMatrix<int>, int>(tsplib_symmetric_path + "rat195.txt");
		auto params = GeneticParameters(
			25,								// Population size
			50,								// Max Generations
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism10_big");
	}
	TEST_METHOD(BenchMarkElitism20Big) {
		auto graph = ParseGraphFile<SymmetricAdjacencyMatrix<int>, int>(tsplib_symmetric_path + "rat195.txt");
		auto params = GeneticParameters(
			25,								// Population size
			50,								// Max Generations
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism20_big");
	}
	TEST_METHOD(BenchMarkElitism30Big) {
		auto graph = ParseGraphFile<SymmetricAdjacencyMatrix<int>, int>(tsplib_symmetric_path + "rat195.txt");
		auto params = GeneticParameters(
			25,								// Population size
			50,								// Max Generations
			...
			Selection::ROULETTE);
		auto solver = GeneticAlgorithm<int>(params);
		RunConfig(solver, graph, max_reps, "elitism\\elitism30_big");
	}
};	
}